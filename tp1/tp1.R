...
coefficients <- t(sapply(ols, function(x) x$coefficients))
...
#Extraemos los coeficientes y los exportamos en un excel
coefficients_bias <- sapply(ols_bias, function(x) x$coefficients)
...
#Extraemos los coeficientes y los exportamos en un excel
coefficients_corr_bias <- sapply(ols_corr_bias, function(x) x$coefficients)
